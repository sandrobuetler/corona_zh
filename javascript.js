...
const setPlzStyleByCases = (globalTemps, i) => {
    ...
    if(newCases === "199+"){
        document.getElementById("_" + plz).style.fill = "#" + reversed[67];
    }else  if (newCases.toString().length < 4 ) {   // 0, 1, 2, 3
